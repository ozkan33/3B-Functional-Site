...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var vendor1, _a, _b, vendor2, _c, _d, retailer1, retailer2, brand1, brand2;
        var _e, _f, _g, _h;
        return __generator(this, function (_j) {
            switch (_j.label) {
                case 0:
                    _b = (_a = prisma.vendor).create;
                    _e = {};
                    _f = {
                        username: 'vendor1'
                    };
                ...
                case 2:
                    vendor1 = _j.sent();
                    _d = (_c = prisma.vendor).create;
                    _g = {};
                    _h = {
                        username: 'vendor2'
                    };
                    return [4 /*yield*/, bcrypt.hash('password456', 10)];
                ...
                case 4:
                    vendor2 = _j.sent();
                    return [4 /*yield*/, prisma.retailer.create({
                            data: {
                                name: 'Retailer A',
                                location: 'New York',
                            },
